...
public class CameraSource {
    ...
    private Camera createCamera() throws IOException {
        ...
        int ratioWidth = CameraOption.getInstance().getRatio().getWidth();
        int ratioHeight = CameraOption.getInstance().getRatio().getHeight();
        SizePair sizePair = selectSizePair(camera, ratioWidth, ratioHeight);
        if (sizePair == null) {
     ...
     * @param ratioWidth  the desired width of the camera preview frames
     * @param ratioHeight the desired height of the camera preview frames
    ...
    private static SizePair selectSizePair(Camera camera, int ratioWidth, int ratioHeight) {
        ...
        for (SizePair sizePair : validPreviewSizes) {
            ...
            float tempRatio = (float) size.getWidth() / (float) size.getHeight();
            float diff = Math.abs(ratio - tempRatio);
            if (diff <= minDiff) {
        ...
        Log.d("PREVIEW_TEST", "ListPreviewSize :" + selectedPair.preview.getWidth() + "," + selectedPair.preview.getHeight());
